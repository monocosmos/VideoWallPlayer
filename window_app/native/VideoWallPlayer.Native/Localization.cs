...
internal sealed class Localizer
{
    private static readonly Dictionary<string, string> Turkish = new()
    {
        ...
        ["display"] = "Ekran",
        ["video.placement"] = "Video yerleşimi",
        ["manual.rectangle"] = "Manuel konum (piksel)",
        ["placement.fit"] = "Oranı koru, ekrana sığdır",
        ["placement.fill"] = "Oranı koru, ekranı doldur/kırp",
        ["placement.stretch"] = "Ekrana ger",
        ["placement.pixel"] = "1:1 piksel, ortala",
        ["placement.integer"] = "Tam kat piksel, ortala",
        ["placement.manual"] = "Manuel X/Y/W/H",
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["display"] = "Display",
        ["video.placement"] = "Video placement",
        ["manual.rectangle"] = "Manual position (pixels)",
        ["placement.fit"] = "Keep ratio, fit to screen",
        ["placement.fill"] = "Keep ratio, fill/crop screen",
        ["placement.stretch"] = "Stretch to screen",
        ["placement.pixel"] = "1:1 pixels, center",
        ["placement.integer"] = "Integer scale, center",
        ["placement.manual"] = "Manual X/Y/W/H",
